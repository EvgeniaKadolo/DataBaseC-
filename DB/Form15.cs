...
namespace DB
{
    public partial class Form15 : Form
    {
        ...
        public Form15(NpgsqlConnection npgsqlConnection)
        {
            InitializeComponent();
            ...
            cmd.CommandText = "SELECT id_type_dish, price, MAX (calories) FROM dish GROUP BY GROUPING SETS ((price, id_type_dish), (price), (id_type_dish), ());";
