...
namespace DB
{
    public partial class Form13 : Form
    {
        ...
        public Form13(NpgsqlConnection npgsqlConnection)
        {
            InitializeComponent();
            ...
            cmd.CommandText = "SELECT name_dish, price, id_type_dish, AVG(price) OVER( PARTITION BY id_type_dish ) FROM dish INNER JOIN type_dish ON type_dish.id_type = dish.id_type_dish ORDER BY price DESC; ";
