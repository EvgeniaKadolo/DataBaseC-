...
namespace DB
{
    public partial class Form22 : Form
    {
        ...
        public Form22(NpgsqlConnection npgsqlConnection)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                ...
                cmd.CommandText = "SELECT name_dish FROM dish WHERE((id_type_dish) = (SELECT id_type FROM type_dish WHERE type_dish = '" + textBox1.Text + "')); ";
